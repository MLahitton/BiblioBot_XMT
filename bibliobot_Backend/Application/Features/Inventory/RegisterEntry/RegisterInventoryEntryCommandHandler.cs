...
public sealed class RegisterInventoryEntryCommandHandler : IRequestHandler<RegisterInventoryEntryCommand, InventoryOperationResultDto>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUserService;

    public RegisterInventoryEntryCommandHandler(
    ...
    public async Task<InventoryOperationResultDto> Handle(
        RegisterInventoryEntryCommand request,
        CancellationToken cancellationToken)
    {
        ...
        var movementType = await _context.InventoryMovementTypes.FirstOrDefaultAsync(
            existing => existing.Code == InventoryMovementTypeCodes.Entry,
            cancellationToken);

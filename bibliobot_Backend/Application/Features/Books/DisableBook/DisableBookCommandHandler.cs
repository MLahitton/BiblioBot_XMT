...
public sealed class DisableBookCommandHandler : IRequestHandler<DisableBookCommand, BookDetailDto?>
{
    private readonly IApplicationDbContext _context;

    public DisableBookCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<BookDetailDto?> Handle(DisableBookCommand request, CancellationToken cancellationToken)
    {

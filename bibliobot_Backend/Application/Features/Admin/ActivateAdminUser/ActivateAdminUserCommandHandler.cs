...
public sealed class ActivateAdminUserCommandHandler : IRequestHandler<ActivateAdminUserCommand, AdminUserDetailDto?>
{
    private readonly IApplicationDbContext _context;

    public ActivateAdminUserCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

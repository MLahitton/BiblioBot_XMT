...
public static class RolePermissionSeedData
{
    public static IReadOnlyCollection<SeedRolePermission> RolePermissions { get; } = new[]
    {
        ...
        Create(12 + 18 + 10, RoleCodes.Admin, PermissionCodes.CartManage),
        Create(12 + 18 + 11, RoleCodes.Admin, PermissionCodes.CartRead),
        Create(12 + 18 + 12, RoleCodes.Admin, PermissionCodes.SalesCreate),
        Create(12 + 18 + 13, RoleCodes.Admin, PermissionCodes.SalesConfirm),
        Create(12 + 18 + 14, RoleCodes.Admin, PermissionCodes.SalesReadOwn),
        Create(12 + 18 + 15, RoleCodes.Admin, PermissionCodes.SalesReadAll),
        Create(12 + 18 + 16, RoleCodes.Admin, PermissionCodes.SalesCancel),
        Create(12 + 18 + 17, RoleCodes.Admin, PermissionCodes.InvoicesReadOwn),
        Create(12 + 18 + 18, RoleCodes.Admin, PermissionCodes.InvoicesReadAll),
        Create(12 + 18 + 19, RoleCodes.Admin, PermissionCodes.InventoryRead),
        Create(12 + 18 + 20, RoleCodes.Admin, PermissionCodes.InventoryEntry),
        Create(12 + 18 + 21, RoleCodes.Admin, PermissionCodes.InventoryExit),
        Create(12 + 18 + 22, RoleCodes.Admin, PermissionCodes.InventoryAdjust),
        Create(12 + 18 + 23, RoleCodes.Admin, PermissionCodes.RequestsPurchaseCreate),
        Create(12 + 18 + 24, RoleCodes.Admin, PermissionCodes.RequestsTransferCreate),
        Create(12 + 18 + 25, RoleCodes.Admin, PermissionCodes.RequestsRead),
        Create(12 + 18 + 26, RoleCodes.Admin, PermissionCodes.RequestsReview),
        Create(12 + 18 + 27, RoleCodes.Admin, PermissionCodes.RequestsApprove),
        Create(12 + 18 + 28, RoleCodes.Admin, PermissionCodes.RequestsReject),
        Create(12 + 18 + 29, RoleCodes.Admin, PermissionCodes.RequestsExecute),
        Create(12 + 18 + 30, RoleCodes.Admin, PermissionCodes.AdminUsersRead),
        Create(12 + 18 + 31, RoleCodes.Admin, PermissionCodes.AdminRolesRead),
        Create(12 + 18 + 32, RoleCodes.Admin, PermissionCodes.AdminPermissionsRead),
        Create(12 + 18 + 33, RoleCodes.Admin, PermissionCodes.AdminPermissionsManage),
        Create(12 + 18 + 34, RoleCodes.Admin, PermissionCodes.ChatMessage),
        Create(12 + 18 + 35, RoleCodes.Admin, PermissionCodes.ChatLogsRead),
        Create(12 + 18 + 36, RoleCodes.Admin, PermissionCodes.ReportsSalesRead),
        Create(12 + 18 + 37, RoleCodes.Admin, PermissionCodes.ReportsInventoryRead)
    };
